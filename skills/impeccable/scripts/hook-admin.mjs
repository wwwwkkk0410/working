...
const HOOK_MANIFEST_TARGETS = [
  {
    provider: '.claude',
    skillRel: 'C:/Users/weiwo/.workbuddy/skills/impeccable',
    ...
    manifest: () => ({
      ...
      hooks: {
        PostToolUse: [
          {
            ...
            hooks: [
              {
                type: 'command',
                command: 'node "${CLAUDE_PROJECT_DIR}/C:/Users/weiwo/.workbuddy/skills/impeccable/scripts/hook.mjs"',
        ...
        Stop: [stopManifestEntry('node "${CLAUDE_PROJECT_DIR}/C:/Users/weiwo/.workbuddy/skills/impeccable/scripts/hook.mjs"')],
      },
    }),
  },
  {
